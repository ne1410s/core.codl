...
export declare type TypedAccessorDecorator<P> = <K extends RecordKey, T extends Record<K, P>>(target: T, key: K, desc: TypedPropertyDescriptor<P>) => void;

/** Defines a decorator for a property or field of type <P>. */
export declare type TypedPropertyDecorator<P> = <K extends RecordKey, T extends Record<K, P>>(target: T, key: K) => void;

/** Defines a decorator for an argument of type <P>. */
export declare type TypedArgumentDecorator<P> = <K extends RecordKey, T extends Record<K, P>>(target: T, key: K, idx: number) => void;
