...
export abstract class ReflectValidation {
  ...
  private static buildTestPlan(allChecks: ValidatorDef[], proto: any, trg: Object, pfx: string = ''): ValidationInstruction[] {  
        ...
        if (valDef) {
          ...
          if (Array.isArray(subobj)) {
            subobj.forEach((subitem, i) => {
              ...
              acc.push(...ReflectValidation.buildTestPlan(allChecks, subproto, subitem || {}, subpfx));
            });
          } else if (subobj) {
